...
An **ad-free** **open-source** iOS application that focus on user privacy and UX more than anything else.<br/>With **Bazel** as build system and **SwiftUI** for interfaces we're going to build from scratch to **AppStore**.
